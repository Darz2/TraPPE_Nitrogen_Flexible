...
with plt.style.context([ 'ieee']):
    ...
    VLE_N2_NIST = np.loadtxt('VLE_NIST.dat', delimiter=' ', skiprows=4)
    VLE_N2_SIM_1 = np.loadtxt('TraPPE-Flex-1/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_N2_SIM_SD_1 = np.loadtxt('TraPPE-Flex-1/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    VLE_N2_SIM_2 = np.loadtxt('TraPPE-Flex-2/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_N2_SIM_SD_2 = np.loadtxt('TraPPE-Flex-2/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    VLE_N2_SIM_36 = np.loadtxt('TraPPE-Flex-36/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_N2_SIM_SD_36 = np.loadtxt('TraPPE-Flex-36/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    VLE_N2_SIM_40= np.loadtxt('TraPPE-Flex-40/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_N2_SIM_SD_40 = np.loadtxt('TraPPE-Flex-40/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    # print(VLE_CO2[0:,0])

    
    SIM_mix = plt.errorbar(VLE_N2_SIM_1[:,1], VLE_N2_SIM_1[:,0], xerr=VLE_N2_SIM_SD_1[:,1],
        fmt=marker_1,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_1[:,2], VLE_N2_SIM_1[:,0], xerr=VLE_N2_SIM_SD_1[:,2],
        fmt=marker_1,
        markersize=markersize,
        markerfacecolor=MIX_face_color,
        markeredgecolor="g",
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_2[:,1], VLE_N2_SIM_2[:,0], xerr=VLE_N2_SIM_SD_2[:,1],
        fmt=marker_1,
        markersize=markersize,
        markeredgecolor='r',
        markeredgewidth=markeredgewidth,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_2[:,2], VLE_N2_SIM_2[:,0], xerr=VLE_N2_SIM_SD_2[:,2],
        fmt=marker_1,
        markersize=markersize,
        markeredgecolor="r",
        markeredgewidth=markeredgewidth,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_36[:,1], VLE_N2_SIM_36[:,0], xerr=VLE_N2_SIM_SD_36[:,1],
        fmt=marker_1,
        markersize=markersize,
        markeredgecolor='b',
        markeredgewidth=markeredgewidth,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_36[:,2], VLE_N2_SIM_36[:,0], xerr=VLE_N2_SIM_SD_36[:,2],
        fmt=marker_1,
        markersize=markersize,
        markeredgecolor="b",
        markeredgewidth=markeredgewidth,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_40[:,1], VLE_N2_SIM_40[:,0], xerr=VLE_N2_SIM_SD_40[:,1],
        fmt=marker_1,
        markersize=markersize,
    ...
    SIM_mix = plt.errorbar(VLE_N2_SIM_40[:,2], VLE_N2_SIM_40[:,0], xerr=VLE_N2_SIM_SD_40[:,2],
        fmt=marker_1,
        markersize=markersize,
        markeredgecolor="cyan",
        markeredgewidth=markeredgewidth,
    ...
    NIST_mix = plt.plot(VLE_N2_NIST[0:,3], VLE_N2_NIST[0:,0],                
        linestyle='solid',
        linewidth=linewidth,
        color='k',
        label=f"REFPROP")
    
    NIST_mix = plt.plot(VLE_N2_NIST[0:,2], VLE_N2_NIST[0:,0],                
        linestyle='solid',
        linewidth=linewidth,
        color='k')
