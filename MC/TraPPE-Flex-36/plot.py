...
with plt.style.context([ 'ieee']):
    ...
    VLE_CO2_NIST = np.loadtxt('VLE_N2_36-5/VLE_NIST.dat', delimiter='\t', skiprows=1)
    VLE_CO2_SIM_5 = np.loadtxt('VLE_N2_36-5/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_CO2_SIM_SD_5 = np.loadtxt('VLE_N2_36-5/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    VLE_CO2_SIM_1 = np.loadtxt('VLE_N2_36-1/TP/VLE.dat', delimiter=' ', skiprows=1)
    VLE_CO2_SIM_SD_1 = np.loadtxt('VLE_N2_36-1/TP/SD_VLE.dat', delimiter=' ', skiprows=1)
    
    VLE_CO2_DIFF = np.loadtxt('VLE_DIFF.dat', delimiter='\t', skiprows=1)
    
    
    
    SIM_mix = plt.errorbar(VLE_CO2_SIM_5[:,1], VLE_CO2_SIM_5[:,0], xerr=VLE_CO2_SIM_SD_5[:,1],
        fmt=marker_1,
    ...
    SIM_mix = plt.errorbar(VLE_CO2_SIM_5[:,2], VLE_CO2_SIM_5[:,0], xerr=VLE_CO2_SIM_SD_5[:,2],
        fmt=marker_1,
        markersize=markersize,
        markerfacecolor=MIX_face_color,
        markeredgecolor="g",
    ...
    SIM_mix = plt.errorbar(VLE_CO2_SIM_1[:,1], VLE_CO2_SIM_1[:,0], xerr=VLE_CO2_SIM_SD_1[:,1],
        fmt=marker_1,
        markersize=markersize,
    ...
    SIM_mix = plt.errorbar(VLE_CO2_SIM_1[:,2], VLE_CO2_SIM_1[:,0], xerr=VLE_CO2_SIM_SD_1[:,2],
        fmt=marker_1,
        markersize=markersize,
        markerfacecolor=CO2_face_color,
        markeredgecolor="r",
    ...
    difference_1 = relative_deviation(VLE_CO2_DIFF[0:,2], VLE_CO2_SIM_1[0:,1])
    print(difference_1*100)
    
    difference_2 = relative_deviation(VLE_CO2_DIFF[0:,2], VLE_CO2_SIM_5[0:,1])
    print(difference_2*100)